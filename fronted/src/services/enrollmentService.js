        ...
        try {
            ...
            return data.map(e => ({
                ...
                course: (e.course || e.Course) ? {
                    ...(e.course || e.Course),
                    thumbnail: (e.course || e.Course).imageUrl || (e.course || e.Course).ImageUrl || 'https://img-c.udemycdn.com/course/480x270/851712_fc61_6.jpg', // Fallback
                    instructorName: (e.course || e.Course).instructor?.name || (e.course || e.Course).Instructor?.Name || 'Instructor'
                } : null
            }));
        } catch (error) {
