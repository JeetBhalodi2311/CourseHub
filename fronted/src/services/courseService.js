...
export const courseService = {
    ...
    async getAllCourses() {
        try {
            ...
            return data.map(course => ({
                id: (course.id || course.Id || '').toString(), // Frontend expects string IDs
                title: course.title || course.Title,
                description: course.description || course.Description,
                price: course.price || course.Price,
                rating: course.averageRating || course.AverageRating || 0, // Map averageRating -> rating
                totalReviews: 0, // Not in backend Course model yet
                thumbnail: course.imageUrl || course.ImageUrl || 'https://img-c.udemycdn.com/course/480x270/851712_fc61_6.jpg', // Use ImageUrl
