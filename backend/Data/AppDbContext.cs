...
namespace CourseHub.Data
{
    public class AppDbContext : DbContext
    {
        ...
        public DbSet<UserVideoProgress> VideoProgress { get; set; }
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // UserVideoProgress → User (Many-to-One)
            ...
            // UserVideoProgress → Lecture (Many-to-One)
            modelBuilder.Entity<UserVideoProgress>()
                .HasOne(vp => vp.Lecture)
                .WithMany()
                .HasForeignKey(vp => vp.LectureId)
                .OnDelete(DeleteBehavior.Restrict);
