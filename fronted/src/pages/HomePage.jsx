        ...
        const fetchEnrollments = async () => {
            if (user) {
                try {
                    ...
                    setEnrolledCourseIds(enrollments.map(e => e.courseId.toString()));
                } catch (err) {
                ...
                <div className="course-grid">
                    {filteredCourses.length > 0 ? (
                        filteredCourses.map(course => (
                            <CourseCard key={course.id} course={course} isEnrolled={enrolledCourseIds.includes(course.id.toString())} />
                        ))
                    ) : (
