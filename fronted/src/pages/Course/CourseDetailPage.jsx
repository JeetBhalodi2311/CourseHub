        ...
        if (hasHalfStar && fullStars < 5) {
            stars.push(
                <div key="half" style={{ position: 'relative', display: 'inline-block' }}>
                    <Star size={14} fill="none" color="#e59819" />
                    <div style={{
                        position: 'absolute',
                        top: 0,
                        left: 0,
            ...
            <div className="course-header-container">
                ...
                <div className="course-header-content">
                    ...
                    <div className="course-badge-row">
                        {courseStats && courseStats.enrollmentCount > 100 && (
                        ...
                        <span className="rating-count">({courseStats?.reviewCount || 0} ratings)</span>
                        <span className="student-count">{courseStats?.enrollmentCount || 0} students</span>
                    </div>
                    ...
                    <div className="sidebar-card">
                        ...
                        <div className="sidebar-content">
                            ...
                            {isEnrolled ? (
                                ...
                                <>
                                    <button className="btn-primary-lg" style={{ opacity: 0.7, cursor: 'default' }} disabled>✓ Already in Cart</button>
                            ...
                            <div className="includes-list">
                                ...
                                <ul>
                                    <li>
                                        <PlayCircle size={16} />
                                        {courseStats ? formatDuration(courseStats.totalDurationMinutes) : '0 minutes'} on-demand video
                                    </li>
