...
import { PlayCircle, MoreVertical, Star, Trash2, FileText, Download } from 'lucide-react';
...
const MyLearningPage = () => {
    ...
    const handleExportNotesPDF = () => {
        ...
        doc.setFontSize(20);
        doc.text("My Course Notes", 14, 22);
        
        let yPos = 35;
        
        // Group notes by course
        const notesByCourse = userNotes.reduce((acc, note) => {
        ...
        Object.entries(notesByCourse).forEach(([courseTitle, notes]) => {
            if (yPos > 270) {
                doc.addPage();
                yPos = 20;
            }
            ...
            notes.forEach(note => {
                ...
                doc.text(`Lecture: ${note.lectureTitle}`, 14, yPos);
                yPos += 6;
                
                doc.setFontSize(10);
                doc.setTextColor(100, 100, 100);
                doc.text(`Date: ${new Date(note.modifiedAt).toLocaleDateString()}`, 14, yPos);
                yPos += 6;
        ...
        <div className="my-learning-page">
            <div className="my-learning-container">
                ...
                <div className="tabs-container">
                    ...
                    <button
                        className={`tab-btn ${activeTab === 'ar8chived' ? 'active' : ''}`}
                ...
                {activeTab === 'notes' ? (
                    <div className="notes-list-container">
                        <div style={{ display: 'flex', justifyContent: 'flex-end', marginBottom: '20px' }}>
                            ...
                            >
                                <Download size={16} /> Export All Notes to PDF
                            </button>
                        </div>
                        {userNotes.length === 0 ? (
